    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 animate-fade-in">
          ...
          <span className="text-white block mt-2">SAS</span>
        </h1>

        <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 mb-8 max-w-4xl mx-auto animate-fade-in delay-200">
          Mantenimiento eléctrico y mecánico
        </p>

        <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-3xl mx-auto animate-fade-in delay-300">
        ...
        <Button 
          size="lg" 
          className="bg-gradient-to-r from-green-500 to-emerald-400 hover:from-green-600 hover:to-emerald-500 text-black font-semibold px-8 py-6 text-lg animate-fade-in delay-500 hover:scale-105 transition-all duration-300"
        >
