        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <span className="bg-gradient-to-r from-green-400 to-emerald-300 bg-clip-text text-transparent">
            ¿Quiénes Somos?
                ...
                <div
                    className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-green-500/20 mb-12">
              ...
              <span className="bg-gradient-to-r from-green-400 to-emerald-300 bg-clip-text text-transparent">
                MISIÓN
                        ...
                        <p className="text-lg text-gray-300 leading-relaxed text-center">
                            ...
                            supervisión y mantenimiento de: equipos avícolas, sistemas eléctricos y
                            mecánicos a nivel residencial e industrial.
                        </p>
                    </div>
